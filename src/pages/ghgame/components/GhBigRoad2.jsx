...
const SECTION_DEFS = [
  ...
  { id: "G", label: "G시리즈", kind: "normal", rows: [["G(H1)", "G(H1)"], ["G(H0)", "G(M1)"], ["G(%1)", "G(%1)"], ["G(%0)", "G(%0)"]] },
    ...
    <Box sx={{ display: "flex", alignItems: "stretch", gap: "4px", mb: "3px" }}>
      ...
      <Box sx={{
        ...
        {pairCells.map((cell, i) => basis
          ...
          : <Cell key={i} cell={cell} onClick={onCellClick && cell?.round ? () => onCellClick(cell.round) : undefined} />)}
      </Box>
    </Box>
  );
}

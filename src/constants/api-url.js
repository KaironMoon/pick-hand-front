...
const HB_GAMES_API = {
  ...
  STATE: (id) => `/api/v1/hb/games/${id}/state`,
...
const LINKED_GAMES_API = {
  START: "/api/v1/linked/start",
  ROUND: "/api/v1/linked/round",
  NEXT: "/api/v1/linked/next",
  END: "/api/v1/linked/end",
  LAST_ROUND: "/api/v1/linked/last-round",
  POLL: "/api/v1/linked/poll",
};

export { API_URL, AUTH_API, USERS_API, SETTINGS_API, HB_SETTINGS_API, HB_GAMES_API, GH_SETTINGS_API, GH_GAMES_API, NC_GAMES_API, NC_SETTINGS_API, WH_GAMES_API, WH_SETTINGS_API, MH_GAMES_API, MH_SETTINGS_API, DH_GAMES_API, DH_SETTINGS_API, USER_BET_SETTINGS_API, APP_SETTINGS_API, LINKED_GAMES_API };
